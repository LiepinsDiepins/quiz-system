...
('Sports', 'Jautājumi par sportu un sacensībām.'),
('Music', 'Jautājumi par mūziku, instrumentiem un māksliniekiem.'),
('Movies', 'Jautājumi par kino un populārām filmām.'),
('Science', 'Jautājumi par dabu, fiziku, bioloģiju un kosmosu.'),
('Geography', 'Jautājumi par valstīm, pilsētām un kontinentiem.');
...
(2, 'Kas parasti nosaka dziesmas tempu?', 'BPM', 'RGB', 'PDF', 'CPU', 'BPM'),
...
INSERT INTO questions (topic_id, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES
(3, 'Kurš režisēja filmu ''Titanic''?', 'James Cameron', 'Steven Spielberg', 'Christopher Nolan', 'Ridley Scott', 'James Cameron'),
(3, 'Kurš varonis dzīvo Gotham City?', 'Batman', 'Superman', 'Shrek', 'Harry Potter', 'Batman'),
(3, 'Kurā filmā ir tēls Jack Sparrow?', 'Pirates of the Caribbean', 'Avatar', 'Gladiator', 'Inception', 'Pirates of the Caribbean'),
...
(3, 'Kas ir animācijas filma?', 'Filma ar zīmētiem vai datorveidotiem tēliem', 'Tikai melnbalta filma', 'Tikai dokumentāla filma', 'Filma bez skaņas', 'Filma ar zīmētiem vai datorveidotiem tēliem'),
(3, 'Kurā filmā redzams tēls Forrest Gump?', 'Forrest Gump', 'Cast Away', 'Top Gun', 'The Terminal', 'Forrest Gump'),
...
(3, 'Kurā filmā cilvēki dzīvo pasaulē ar zilas ādas Na''vi?', 'Avatar', 'Dune', 'Frozen', 'Coco', 'Avatar'),
(3, 'Filmas noslēguma uzraksti tiek saukti par...', 'Titriem', 'Kadriem', 'Scenāriju', 'Treileri', 'Titriem');

INSERT INTO questions (topic_id, question_text, option_a, option_b, option_c, option_d, correct_answer) VALUES
(4, 'Kura planēta ir vistuvāk Saulei?', 'Merkurs', 'Venēra', 'Marss', 'Jupiters', 'Merkurs'),
(4, 'H2O ir ķīmiskais apzīmējums...', 'Ūdenim', 'Skābeklim', 'Sālim', 'Ogleklim', 'Ūdenim'),
(4, 'Kurš orgāns pumpē asinis cilvēka ķermenī?', 'Sirds', 'Aknas', 'Plaušas', 'Nieres', 'Sirds'),
(4, 'Kā sauc spēku, kas velk objektus uz Zemi?', 'Gravitācija', 'Berze', 'Magnētisms', 'Elektrība', 'Gravitācija'),
(4, 'Kurš no šiem ir zīdītājs?', 'Delfīns', 'Haizivs', 'Ķirzaka', 'Varde', 'Delfīns'),
...
(4, 'Kura gāze cilvēkam nepieciešama elpošanai?', 'Skābeklis', 'Hēlijs', 'Oglekļa monoksīds', 'Argons', 'Skābeklis'),
...
(5, 'Kurš okeāns ir lielākais?', 'Klusais okeāns', 'Atlantijas okeāns', 'Indijas okeāns', 'Arktikas okeāns', 'Klusais okeāns'),
