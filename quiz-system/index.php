...
<section class="auth-grid">
    <div class="card hero-card">
        ...
        <p>Ielogojies vai reģistrējies, izvēlies tematu, atbildi uz 15 jautājumiem un apskati savu rezultātu.</p>
    ...
    <div class="card auth-card">
        ...
        <p class="small-note">Demo admin lietotājs pēc SQL importēšanas: <strong>admin</strong> / <strong>admin123</strong></p>
    </div>
</section>
